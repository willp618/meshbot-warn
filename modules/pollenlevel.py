...
class PollenLevels():
    def __init__(self, locations):
        self.pollen_api = "https://air-quality-api.open-meteo.com/v1/air-quality?latitude={0}&longitude={1}&current=alder_pollen,birch_pollen,grass_pollen,mugwort_pollen,ragweed_pollen"
